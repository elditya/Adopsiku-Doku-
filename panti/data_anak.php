...
<section class="hero-wrap hero-wrap-2" style="background-image: url('../images/bg_2.jpg');">
    ...
    <a href="menambah_data_anak.php?id_panti=<?php echo $data['id_panti']; ?>" class="btn btn-lg btn-outline-success">Menambah data anak</a>
...
$query_mysql = mysqli_query($host, "SELECT * FROM table_anak where status_adopsi like 'belum diadopsi' and nama_panti = '$nama_panti'");
          ...
          <div class="card" style="width: 18rem;">
             ...
             <p class="btn-outline-warning">Umur : <?php echo $data['umur_anak']; ?></p>
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group">
                  <a href="edit_data_anak.php?id_anak=<?php echo $data['id_anak']; ?>" class="btn btn-sm btn-outline-warning">Edit Data Anak</a>          
                </div>
              </div>
            </div>
          </div>
