      ...
      <div class="container row3">
        <div class="row">
            ...
            <div class="ml-md-5 col-ex-5 text-uppercase">
              ...
              <form method="POST" action="proses/config_tahapan1.php"  enctype="multipart/form-data">
                          <?php
                          ...
                          ?>
                                ...
                                <div class="input-group mb-3">
                                    <h5 class="">Isi Berkas Tahapan 1</h5>
                                </div>
                               
                                <div class="input-group mb-3">
                                  <span class="input-group-text" id="basic-addon1">Nama Adopter</span>
                                  <input type="hidden" class="form-control form-control-user" id="id" name="id_th1" readonly>
                                ...
                                <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1"> Tanggal Tahapan </span>                                  
                                  <input class="form-control" type="file" name="tahapan1"  >
                                </div>
