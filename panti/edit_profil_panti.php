...
<html lang="en">
  ...
  <div class="py-2 bg-primary">
    ...
    <div class="container emp-profile">
					...
					?>
            <form action="proses/edit_profil_config.php" method="post"  enctype="multipart/form-data" >
            ...
            <?php
                    ...
                    <div class="col-md-4">
                        <div class="profile-img">
                            ...
                            <div class="file btn btn-lg btn-primary">
                                Change Photo
                                <input type="file" name="foto_pf"/>
                                <input type="hidden" name="foto_lama_pf" value="<?php echo $data['foto_pf'] ?>"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="profile-img mt-md-2">
                            ...
                            <div class="file btn btn-lg btn-primary">
                                Change Photo
                                <input type="file" name="foto_panti"/>
                                <input type="hidden" name="foto_lama_panti" value="<?php echo $data['foto_panti'] ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel">
                                        <div class="row">
                                           ...
                                           <div class="col-md-6 ">
                                                <input  type="hidden" name="id_panti" value="<?php echo $data['id_panti'] ?>"> 
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 ">
                                                <input  type="text" name="nama_panti" value="<?php echo $data['nama_panti'] ?>"> 
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 ">
                                                <input  type="text" name="alamat_panti" value="<?php echo $data['alamat_panti'] ?>"> 
