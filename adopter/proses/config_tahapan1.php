...
mysqli_query($host, "UPDATE tahapan1 SET  nama_adopter='$nama_adopter', nama_panti='$nama_panti', nama_anak ='$nama_anak', hari = '$hari',jam = '$jam', tgl = '$tgl', tahapan1 = '$tahapan1' , kode ='$kode ',deskripsi ='$deskripsi ' WHERE id_th1 ='$id_th1'");
