  ...
  <th>
          ...
          <div class="col-md-8">
            <div class=" col-lg-8 card-body row3">
              ...
              <input type="hidden" name="nama_anak" value="<?php echo $data['nama_anak']; ?>">
                ...
                <textarea type="text" name="deskripsi"><?php echo $data['deskripsi']; ?></textarea></h5>
            </div>
      ...
      <form action="proses/selesai.php"  method="post">
        <?php 
              ...
              <input type="hidden" name="nama_panti" value="<?php echo $data['nama_panti']; ?>">
              <input type="hidden" name="nama_anak" value="<?php echo $data['nama_anak']; ?>">
              <input type="hidden" name="hari" value="<?php echo $jkt1; ?>">
              <input type="hidden" name="bulan" value="<?php echo $jkt2; ?>">
              <input type="hidden" name="tahun" value="<?php echo $jkt3; ?>">
              <input type="hidden" name="tgl_selesai" value="<?php echo $jkt; ?>">
              <input type="hidden" name="kode" value="<?php echo $data['kode']; ?>">
              <div class="bg-light align-self-stretch box p-4 text-center ">
              <input class="btn btn btn-outline-success" type="submit" value="Selesai">
	          </div>
