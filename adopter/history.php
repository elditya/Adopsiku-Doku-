                                ...
                                <table id="bootstrap-data-table-export" class="table   table-bordered  ">
                                    <thead>
                                        ...
                                        <?php
                                          ...
                                          $no = 1;
                                          $query_mysql = mysqli_query($host,"SELECT * from history  where nama_adopter = '$adopter'");
                                        ...
                                        <tr>
                                          ...
                                          <th><a href="proses/pdf_adopsi.php?nama_anak=<?php echo $data['nama_anak']; ?>" target="_blank"  class="btn btn btn-outline-success">Report PDF</a></th>
                                        </tr>
                                        <?php } ?>
