...
?>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">KATEGORI ANAK BALITA</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="container text-uppercase">
      <h5 class="mb-2 bread">Album para Balita yang berusia sekitar 5 tahun kebawah<br>yang ada di panti panti asuhan atau yayaasan yang ada di aplikasi kita</h5>
    </div>
  </section>
...
include "../koneksi.php";
$query_mysql = mysqli_query($host, "SELECT * FROM table_anak WHERE umur_anak < 6 AND status_adopsi like 'belum diadopsi'  ");
          ...
          <div class="card" style="width: 18rem;">
             ...
             <p class="btn-outline-warning">Umur : <?php echo $data['umur_anak']; ?></p>
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="detail_balita.php?id_anak=<?php echo $data['id_anak']; ?>" class="btn btn-sm btn-outline-info">Liat Detail</a>
                </div>
                <div class="btn-group">
